...
public class ProductApiController {
    ...
    @ApiOperation(
            value = "product 찾기",
            notes = "Response : ProductDetailDto",
            code = 200
    )
    @GetMapping("/{id}")
    ...
    @ApiOperation(
            ...
            notes = "productName, price x~x, stock x~, popular x~ 에 대해서 조건을 줄 수 있습니다. <br>" +
                    "예를 들어서 priceBegin 은 특정 인수값 이상, 그리고 priceEnd는 이하의 조건을 가지는 특정 item 하위의 모든 product를 조회합니다.<br>" +
    ...
    @ApiOperation(
            ...
            notes = "특정 post에 products를 등록합니다. products는 Long type array입니다 <br>" +
                    "Response : Nothing",
            code = 200
    )
