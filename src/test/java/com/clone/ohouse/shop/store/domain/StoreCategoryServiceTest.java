...
public class StoreCategoryServiceTest {
    ...
    public void findBundleViewAllOrderByPopular() {
        ...
        StorePosts post1 = storePostsRepository.save(new StorePostsSaveRequestDto("제목1", "내용1", null, "JJH").toEntity());
        StorePosts post2 = storePostsRepository.save(new StorePostsSaveRequestDto("제목2", "내용2", null, "AAA").toEntity());
        StorePosts post3 = storePostsRepository.save(new StorePostsSaveRequestDto("제목3", "내용3", null, "BBB").toEntity());
        StorePosts post4 = storePostsRepository.save(new StorePostsSaveRequestDto("제목4", "내용4", null, "CCC").toEntity());
